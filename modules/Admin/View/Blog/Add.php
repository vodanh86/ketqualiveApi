<div class="page_width">
    ...
    <form class="mava_form form_add_post" id="form_add_post" action="<?php echo Mava_Url::buildLink('admin/blog/add'); ?>" method="post" enctype="multipart/form-data">
        <h2 class="mava_form_title"><?php echo __('add_post'); ?></h2>
        <div class="mava_form_rows">
            ...
            <dl class="row">
                ...
                <dd><input type="file" class="input_text" name="postCover" id="postCover" accept="image/*" /></dd>
            </dl>
