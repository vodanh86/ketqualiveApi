<div class="pg-title form-title alert alert-success">Nâng cấp Supervip thành công </div>
<div class="pg-content form-content">
	<div class="row">
		<div class="col-md-12 col-sm-12 col-12">
			<form id="upgrade-vip" data-parsley-validate="" class="form-horizontal form-label-left">
			   	...
			   	<div class="form-group">
			      	<label class="control-label" for="first-name">Supervip</label>
			      	</label>
                    <input required readonly type="text" value="<?php echo $user['is_supervip'] == 1 ? 'Có' : 'Không'?>" class="form-control">
			   	</div>
