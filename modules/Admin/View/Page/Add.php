<div class="page_width">
    ...
    <form class="mava_form form_add_phrase" id="form_add_page" action="<?php echo Mava_Url::buildLink('admin/page/add'); ?>" method="post">
        <h2 class="mava_form_title"><?php echo __('add_new_static_page'); ?></h2>
