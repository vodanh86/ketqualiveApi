<div class="page_width">
    ...
    <form class="mava_form form_edit_campaign" id="form_edit_campaign" action="<?php echo Mava_Url::buildLink('admin/ads/edit-campaign-group', array('id' => $campaign['id'])); ?>" method="post">
        <h2 class="mava_form_title"><?php echo __('add_campaign_group'); ?></h2>
        <div class="mava_form_rows">
            <dl class="row">
                <dt><?php echo __('name'); ?> <b>*</b></dt>
                <dd><input type="text" class="input_text input_medium campaignGroupTitle" name="campaignGroupTitle" id="campaignGroupTitle" value="<?php echo htmlspecialchars($campaign['title']); ?>" /></dd>
            </dl>
            <dl class="row">
                <dt><?php echo __('color'); ?></dt>
                <dd><input type="color" class="input_text input_medium campaignGroupColor" name="campaignGroupColor" id="campaignGroupColor" value="<?php echo htmlspecialchars($campaign['color']); ?>" /></dd>
            </dl>
            <dl class="row">
                <dt><?php echo __('sort_order'); ?></dt>
                <dd class="mava_spinbox">
                    <input type="text" class="input_text input_short mava_spinbox_value" data-step="1" data-min="0" value="<?php echo intval($campaign['sort_order']); ?>" name="campaignGroupSortOrder" id="campaignGroupSortOrder">
