<div class="pg-title form-title alert alert-success">Đặt lại mật khẩu thành công </div>
<div class="pg-content form-content">
	<div class="row">
		<div class="col-md-12 col-sm-12 col-12">
			<form id="reset-pass" data-parsley-validate="" class="form-horizontal form-label-left">
