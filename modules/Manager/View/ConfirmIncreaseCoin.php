<div class="pg-title form-title">Xác nhận cộng COIN</div>
<div class="pg-content form-content">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-12">
			<form id="incre-coin" data-parsley-validate="" class="form-horizontal form-label-left" action="<?php echo Mava_Url::buildLink('manager/confirm-increase-coin?user_id='.$userId.'&coin='.$coin)?>" method="post">
				<div class="form-group">
			   	...
			   	<div class="form-group">
			      	<label class="control-label" for="first-name">Số coin</label>
			      	</label>
			        <input required readonly type="text" id="coin" name="coin" value="<?php echo $coin > 0 ? $coin : '' ?>" class="form-control">
			   	</div>
				<div class="form-group col-md-offset-3">
					<button type="submit" class="btn btn-success">Cộng</button>
					<a href="<?php echo Mava_Url::getPageLink('manager/increase-coin?user_id='.$userId.'&coin='.$coin)?>"><button type="button" class="btn btn-primary">Quay lại</button></a>
				</div>
			</form>
		</div>
	</div>
