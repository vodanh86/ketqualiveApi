...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Mava_View::getCssUrl('app') .'?v='. time(); ?>" />
...
<!--    <script type="text/javascript" src="--><?php //echo Mava_View::getJsUrl('jquery-3.2.1.slim.min'); ?><!--"></script>-->
    ...
    <script type="text/javascript" src="<?php echo Mava_View::getJsUrl('app') .'?v='. time(); ?>"></script>
...
<div id="header" class="homepage_header">
    <?php
    echo Mava_View::getView('Mava_View_Common_TopMenu');
    ?>
</div>
    <?php
        if(is_login()){
...
<div class="col-md-4">
    <?php echo Mava_View::getView('Loto_View_Block_Check'); ?>
    <?php echo Mava_View::getView('Loto_View_Block_StatsList'); ?>
    <?php echo Mava_View::getView('Loto_View_Block_RulesList'); ?>
    <?php echo Mava_View::getView('Loto_View_Block_Fanpage'); ?>
</div>
</div>
</div>
