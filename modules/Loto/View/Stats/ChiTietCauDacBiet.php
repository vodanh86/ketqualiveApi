<div class="xs-box">
    ...
    <div class="xs-box-body">
        <p>Chi tiết cầu đặc biệt ngày <?php echo $date ?> tại vị trí <span class="red bold"><?php echo $position_1.'-'.$position_2 ?></span></p>
        <p>Theo cầu này dự đoán ngày <?php echo $date ?> đặc biệt sẽ về
