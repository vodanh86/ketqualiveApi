<div class="xs-box">
    <div class="xs-box-head">Soi cầu truyền thống - về hai nháy</div>
    <div class="xs-box-body">
        <form action="<?php echo Mava_Url::getPageLink('soi-cau-ve-hai-nhay'); ?>" method="GET" onsubmit="return showSoiCauVeHaiNhayResult();">
            <div class="row">
                <div class="col-md-6">
...
<script type="text/javascript">
    function showSoiCauVeHaiNhayResult(){
        window.location.href = DOMAIN +'/soi-cau-ve-hai-nhay-ngay-' + $('#xs_find_date').val()
        return false;
    }
</script>