<div class="page_width">
    ...
    <form class="mava_form form_add_user_group" id="form_add_page_group" action="<?php echo Mava_Url::buildLink('admin/page/group_add'); ?>" method="post" enctype="multipart/form-data">
        <h2 class="mava_form_title"><?php echo __('add_page_group'); ?></h2>
