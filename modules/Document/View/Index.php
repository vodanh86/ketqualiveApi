                        ...
                        <div class="rm-box">
                            <div class="container">
                                <h2 class="rm-box-title clearfix">
                                    <span class="pull-left"><a href="<?php echo Mava_Url::getPageLink('tai-lieu/'. Mava_String::unsignString($cat['title'], '-')); ?>"><?php echo htmlspecialchars($cat['title']); ?></a></span>
                                    <a class="pull-right rm-title-more" href="<?php echo Mava_Url::getPageLink('tai-lieu/'. Mava_String::unsignString($cat['title'], '-')); ?>"><?php echo __('view_more'); ?> <i class="fa fa-caret-right"></i></a>
                                </h2>
                                <div class="rm-document-list-wrap">
                                        <?php
                                            if(isset($cat['docs']['rows']) && is_array($cat['docs']['rows']) && count($cat['docs']['rows']) > 0){
                                                echo '<div class="rm-document-list clearfix">';
                                                foreach($cat['docs']['rows'] as $doc){
