...
class Mava_Loader
{
    ...
    public function autoload($class)
    {
        ...
        if (substr($class, 0, 5) == 'MVCP_')
        {
            throw new Mava_Exception('Cannot load class using MVCP. Load the class using the correct loader first.');
        }
    ...
    public static function setInstance(Mava_Loader $loader = null)
    {
