<div class="page_width">
    ...
    <form class="mava_form form_add_permission_group" id="form_add_permission_group" action="<?php echo Mava_Url::buildLink('admin/permission/group_add'); ?>" method="post" enctype="multipart/form-data">
        <h2 class="mava_form_title"><?php echo __('add_permission_group'); ?></h2>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#button_submit_add').click(function(){
            $('#form_add_permission_group').submit();
        });
        $('#form_add_permission_group').submit(function(){
            if($('#groupTitle').val()==''){
                $('#groupTitle').focus();
                return false;
            }else{
