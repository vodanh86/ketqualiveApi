<div class="page_width">
    ...
    <form class="mava_form form_edit_item" id="form_edit_item" action="<?php echo Mava_Url::buildLink('admin/menu/edit', array('id' => $itemId)); ?>" method="post">
        <h2 class="mava_form_title"><?php echo __('edit_menu'); ?></h2>
