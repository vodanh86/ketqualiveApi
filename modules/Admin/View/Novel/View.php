<div class="page_width">
    ...
    <div class="table_action_button clearfix">
        ...
        <div class="fr">
            <a class="mava_button mava_button_gray" href="<?php echo Mava_Url::buildLink('admin/novel/addChapter',array('novelId' => $novelId)); ?>">+ <?php echo __('add_chapter'); ?></a>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.button_delete_user').on('click',function(){
            var chapterId = $(this).attr('user-id');
            var name = $(this).attr('user-title');
            MV.dialog.st_confirm('<?php echo __('delete_chapter_confirm'); ?><div class="space"></div><b>'+ name +' - '+ chapterId +' (ID: '+ chapterId +')</b>',function(){
                MV.post(DOMAIN+'/admin/novel/deleteChapter',{
                    chapterId: chapterId
                },function(res){
                        if(res.status==1){
