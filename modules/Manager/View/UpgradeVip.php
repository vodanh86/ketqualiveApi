<div class="pg-title form-title">Nâng cấp VIP</div>
<div class="pg-content form-content">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-12">
			<form id="upgrade-vip" data-parsley-validate="" class="form-horizontal form-label-left" action="<?php echo $userId > 0 ? Mava_Url::buildLink('manager/upgrade-vip?user_id='.$userId) :  Mava_Url::buildLink('manager/upgrade-vip')?>" method="post">
				<div class="form-group">
			   	...
			   	<div class="form-group">
			        ...
			        <input required type="text" id="num" name="num" value="<?php echo $num > 0 ? $num : '' ?>" class="form-control">
			   	</div>
