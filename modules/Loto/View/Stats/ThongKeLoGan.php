<div class="xs-box">
    <div class="xs-box-head">Thống kê lô gan</div>
    <div class="xs-box-body">
        <form action="<?php echo Mava_Url::getPageLink('thong-ke-lo-gan'); ?>" method="GET" onsubmit="return showLoGanResult();">
            <div class="row">
                <div class="col-md-6">
                    <label for="xs_thongkelogantheotinh_province">Chọn tỉnh</label>
                    <select class="form-control form-control-sm" id="xs_thongkelogantheotinh_province">
                        <?php
        ...
        <div id="xs_stats_result">
            <?php
                if(isset($result_html) && $result_html != ""){
                    ...
                    echo '<div class="alert alert-warning"><b>Hướng dẫn:</b> Chọn tỉnh thành muốn xem thống kê, sau đó bấm vào nút "Xem kết quả".</div>';
                }
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    function showLoGanResult(){
        window.location.href = DOMAIN +'/thong-ke-lo-gan-'+ $('#xs_thongkelogantheotinh_province option:selected').attr('data-slug')
        return false;
    }
</script>