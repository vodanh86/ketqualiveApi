    <div class="container">
        <div class="rm-single-list-content">
            <h3 class="rm-box-title"><?php echo __('book_coming_soon'); ?></h3>
            <div class="rm-single-list-list">
                ...
                echo '<div class="text-center">'. Mava_View::buildPagination(Mava_Url::getPageLink('sap-phat-hanh'),ceil($total/$limit),$page,5) .'</div>';
