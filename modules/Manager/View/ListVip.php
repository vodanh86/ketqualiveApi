<div class="pg-title user-vip-title"><?php echo __('Danh sách thành viên VIP') .' ('.$total.')' . ($searchTerm!=""?": ". htmlspecialchars($searchTerm):""); ?></div>
<div class="pg-content user-vip-content">
   <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
      <div class="row mb-4">
         <div class="col-md-6">
            <form name="form_search_item" id="form_search_item" action="<?php echo Mava_Url::buildLink('manager/user-vip'); ?>" method="get">
         ...
         <div class="col-md-6 col-sm-6 col-6">
            <?php
               ...
               echo Mava_View::buildPaginationBootrap(
                  Mava_Url::buildLink('manager/user-vip',$paginateParams),
                  ceil($total/$limit),
                  $page,
                  3,
