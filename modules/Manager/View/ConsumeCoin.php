<div class="pg-title charge-coin-title"><?php echo __('Danh sách dùng coin') .' ('.$total.')' . ($searchTerm!=""?": ". htmlspecialchars($searchTerm):""); ?></div>
<div class="pg-content charge-coin-content">
   <div id="datatable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
      <div class="row mb-4">
         <div class="col-md-6">
            <form name="form_search_item" id="form_search_item" action="<?php echo Mava_Url::buildLink('manager/consume-coin'); ?>" method="get">
               ...
               <thead>
                  <tr role="row">
                     ...
                     <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"style="width: 60px;">Điện thoại</th>
                      <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"style="width: 90px;">Loại</th>
                     <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"style="width: 115px;">Coin thay đổi</th>
                     <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"style="width: 90px;">Coin trước</th>
                     <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"style="width: 90px;">Coin sau</th>
                     <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"style="width: 115px;">Ngày thực hiện</th>
                  </tr>
               </thead>
               <tbody>
                  <?php
         ...
         <div class="col-md-6 col-sm-6 col-6">
            <?php
               ...
               echo Mava_View::buildPaginationBootrap(
                  Mava_Url::buildLink('manager/consume-coin',$paginateParams),
                  ceil($total/$limit),
                  $page,
                  3,
