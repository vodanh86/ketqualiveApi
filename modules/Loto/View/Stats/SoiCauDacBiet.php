<div class="xs-box">
    <div class="xs-box-head">Soi cầu truyền thống - đặc biệt</div>
    <div class="xs-box-body">
        <form action="<?php echo Mava_Url::getPageLink('soi-cau-dac-biet'); ?>" method="GET" onsubmit="return showSoiCauDacBietResult();">
            <div class="row">
                <div class="col-md-6">
...
<script type="text/javascript">
    function showSoiCauDacBietResult(){
        window.location.href = DOMAIN +'/soi-cau-dac-biet-ngay-' + $('#xs_find_date').val()
        return false;
    }
</script>